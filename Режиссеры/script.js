...
directors.forEach((point) => {
  let div = `<div class="point">
    <div class="point__main-info">
    <h3 class="point__name">${point.name}</h3>
    <p class="point__career">${point.career}</p>
    </div>
    <a href="${point.films}">Фильмография</a>
    </div>`;
