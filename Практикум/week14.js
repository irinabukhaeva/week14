...
const mySecondArray = [456, 789, 123, 894, 4541531, 36565]; // объявите переменную здесь
...
const myInformation = ["Ira", 26, "january", "Aquarius"];
...
function sortAndPrint() {
  const sortNumbers = randomNumbers.sort();
